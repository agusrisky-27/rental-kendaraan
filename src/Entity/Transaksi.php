<?php
    ...
    class Transaksi
    {
        ...
        public function getPelanggan(): Pelanggan  { return $this->pelanggan; }
        public function getKendaraan(): Kendaraan  { return $this->kendaraan; }
        public function getTanggalSewa(): \DateTime { return $this->tanggalSewa; }
        public function getTanggalKembali(): \DateTime { return $this->tanggalKembali; }
        public function getLamaSewa(): int         { return $this->lamaSewa; }
        public function getTotalHarga(): string    { return $this->totalHarga; }
        public function getStatus(): string        { return $this->status; }

        public function setUser(User $v)               { $this->user           = $v; }
        public function setPelanggan(Pelanggan $v)      { $this->pelanggan      = $v; }
        public function setKendaraan(Kendaraan $v)      { $this->kendaraan      = $v; }
        public function setTanggalSewa(\DateTime $v)    { $this->tanggalSewa    = $v; }
        public function setTanggalKembali(\DateTime $v) { $this->tanggalKembali = $v; }
        public function setLamaSewa(int $v)             { $this->lamaSewa       = $v; }
        public function setTotalHarga(string $v)        { $this->totalHarga     = $v; }
