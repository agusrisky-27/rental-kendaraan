<?php
    ...
    class Pelanggan {
        ...
        public function getNomorIdentitas(): string { 
        ...
        public function setAlamat(string $v){ 
            $this->alamat = $v; 
        }
        public function setNoHp(string $v) { 
            $this->noHp = $v; 
        }
        public function setNomorIdentitas(string $v) { 
            $this->nomorIdentitas = $v; 
        }
